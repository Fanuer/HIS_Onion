...
namespace HIS.WebApi.SecretStore.V2.Repositories
{
    ...
    /// </summary>
    internal class MongoDbClientRepository: IClientRepository
    {
        #region CONST
        ...
        /// <summary>
        /// Creates a new MongoDbClientRepository object
        /// </summary>
        /// <param name="options">provides options to connect to the MongoDB</param>
        public MongoDbClientRepository(IOptions<MongoDbOptions> options)
        {
